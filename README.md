...
5. You will not use any endpoint not explicitly documented in the OpenAPI specification (obviously I can't prevent this, but it's annoying and can cause data integrity issues).
